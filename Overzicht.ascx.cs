...
{
    public partial class Overzicht : CompanyModuleBase
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                sDownloadUrl = ConvertRelativeUrlToAbsoluteUrl("/DesktopModules/Company/Beheer/Project/ProjectPDF.aspx");
                sDownloadUrl += "?pd=" + Request["PD"] + "&se=true";
            }

            if (Session["Company_Project_Overview_Filter_Klant"] != null)
            {
                bFilter = true;
                ...
                try
                {
                    currentCustomers.Add(
                        Data.Functies.Klanten.GetById(int.Parse(Session["Company_Project_Overview_Filter_Klant"].ToString())));
                }
                catch
                {
                }
                ...
                rlbKlant.DataBind();
                rlbKlant.SelectedValue = Session["Company_Project_Overview_Filter_Klant"].ToString();
            }
            if (Session["Company_Project_Overview_Filter_Locatie"] != null)
            {
                bFilter = true;
                ...
                try
                {
                    currentLocations.Add(
                        Data.Functies.Klant_Locaties.GetById(
                            int.Parse(Session["Company_Project_Overview_Filter_Locatie"].ToString())));
                }
                catch
                {
                }
                ...
                rlbLocatie.DataBind();
                rlbLocatie.SelectedValue = Session["Company_Project_Overview_Filter_Locatie"].ToString();
            }
            if (Session["Company_Project_Overview_Filter_Status"] != null)
            {
                bFilter = true;
                rlbStatus.SelectedValue = Session["Company_Project_Overview_Filter_Status"].ToString();
            }
            if (Session["Company_Project_Overview_Filter_Projectnummer"] != null)
            {
                txtProjectnummer.Text = Session["Company_Project_Overview_Filter_Projectnummer"].ToString();
                bFilter = true;
            }
            if (Session["Company_Project_Overview_Filter_Opdrachtnummer"] != null)
            {
                txtOpdrachtnummer.Text = Session["Company_Project_Overview_Filter_Opdrachtnummer"].ToString();
                bFilter = true;
            }
        }
...
*/
        ...
        {
            Session.Remove("Company_Project_Overview_Filter_Klant");
            Session.Remove("Company_Project_Overview_Filter_Locatie");
            Session.Remove("Company_Project_Overview_Filter_Status");
            Session.Remove("Company_Project_Overview_Filter_Projectnummer");
            Session.Remove("Company_Project_Overview_Filter_Opdrachtnummer");
            ...
            if (IsFileUploaded)
            {
                ...
                try
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        lProject = null;
                        using (var db = new Ncdo.Company.Data.Entiteiten.Entities())
                        {
                        ...
                        if (lProject != null)
                        {
                            ...
                            if (lManagementInfo != null)
                                Ncdo.Company.Data.Functies.ManagementInfo.Delete(lProject.Project_Id);
                            ...
                            Ncdo.Company.Data.Functies.ManagementInfo.Add(mi);
                        }
                    }
                }
                catch (Exception ex)
